...
class UncompleteOrder extends StatefulWidget {
  @override
  _UncompleteOrderState createState() => _UncompleteOrderState();
}

class _UncompleteOrderState extends State<UncompleteOrder> {
  @override
