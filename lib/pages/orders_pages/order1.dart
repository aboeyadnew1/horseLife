              ...
              return InkWell(
                onTap: () {
                  ...
                  Navigator.of(context)
                      .pushNamed(PurchaseOrdersDetails.id, arguments: data);
                },
                child: Container(
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'رقم الطلب : ' +
                                      getorderbystatue[index].id.toString(),
                                  style: TextStyle(
                                    fontSize: 16.0,
                                    fontFamily: 'Cairo',
                                ...
                                Text(
                                  'العنوان : ' +
                                      getorderbystatue[index].address,
                                  style: TextStyle(
                                    fontSize: 16.0,
                                    fontFamily: 'Cairo',
                                    fontWeight: FontWeight.w500,
                                ...
                                Text(
                                  'تاريخ الانشاء : ' +
                                      getorderbystatue[index].creation_date,
                                  style: TextStyle(
                                    fontSize: 16.0,
                                    fontFamily: 'Cairo',
                                    fontWeight: FontWeight.w500,
                                ...
                                Text(
                                  getorderbystatue[index].delivered_date == null
                                      ? ""
                                      : getorderbystatue[index].delivered_date,
                                  style: TextStyle(
                                    fontSize: 16.0,
                                    fontFamily: 'Cairo',
                                    fontWeight: FontWeight.w500,
                                ...
                                Text(
                                  getorderbystatue[index].statue == "0"
                                      ? "تحت الاجراء"
                                      : getorderbystatue[index].statue == "1"
                                          ? "جاري الشحن"
